"""A collection of test cases and solutions for `contains_duplicates_II.py` tests."""
...
class TestCases:
    ...
    test_string = "Case: 2000-long case. No matches."
    test_input_1 = [
        0,
        1,
        2,
    ...
    test_string = "Case: 2000-long case. No matches. K longer than list."
    test_input_1 = [
        0,
        1,
        2,

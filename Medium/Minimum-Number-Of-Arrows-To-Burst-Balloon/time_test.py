...
"""
MYCODE = """
RESULT = sol.find_min_arrow_shots_1(x)
"""
TIME_PER_RUN = str(
    timeit.timeit(setup=MYSETUP, stmt=MYCODE, number=NUM_TESTS) / NUM_TESTS
)
print("find_min_arrow_shots_1():" + TIME_PER_RUN)


# Someone else's solution
MYCODE = """
RESULT = sol.find_min_arrow_shots_2(x)
"""
TIME_PER_RUN = str(
    timeit.timeit(setup=MYSETUP, stmt=MYCODE, number=NUM_TESTS) / NUM_TESTS
)
print("find_min_arrow_shots_2():" + TIME_PER_RUN)


# Someone else's solution
MYCODE = """
RESULT = sol.find_min_arrow_shots_3(x)
"""
TIME_PER_RUN = str(
    timeit.timeit(setup=MYSETUP, stmt=MYCODE, number=NUM_TESTS) / NUM_TESTS
)
print("find_min_arrow_shots_3():" + TIME_PER_RUN)

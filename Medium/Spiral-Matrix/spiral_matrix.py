""" 
The methods of this module return a list of the order of items
if you were to traverse in a spiral around the given matrix if
you were to start at the top left, or [0,0].
"""
